...
class DataplexServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(DataplexServiceClient).get_transport_class, type(DataplexServiceClient))
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_lake_actions(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_zone_actions(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_asset_actions(self,
