...
@pytest.mark.asyncio
async def test_get_entity_async(transport: str = 'grpc_asyncio', request_type=metadata.GetEntityRequest):
...
@pytest.mark.asyncio
async def test_list_entities_async(transport: str = 'grpc_asyncio', request_type=metadata.ListEntitiesRequest):
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(metadata.ListEntitiesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_entities_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, metadata.Entity)
                   for i in results)
...
@pytest.mark.asyncio
async def test_get_partition_async(transport: str = 'grpc_asyncio', request_type=metadata.GetPartitionRequest):
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_partitions_async(transport: str = 'grpc_asyncio', request_type=metadata.ListPartitionsRequest):
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(metadata.ListPartitionsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_partitions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = [i for i in pager]
        assert len(results) == 6
        assert all(isinstance(i, metadata.Partition)
                   for i in results)
